...
var (
	filter_GoodsService_GetGoodsStock_0 = &utilities.DoubleArray{Encoding: map[string]int{"goods_id": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
)
...
func request_GoodsService_GetGoodsStock_0(ctx context.Context, marshaler runtime.Marshaler, client GoodsServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_GoodsService_GetGoodsStock_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
var (
	pattern_GoodsService_GetGoodsStock_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"v1", "goods", "goods_id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_GoodsService_GetGoodsStocks_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"v1", "goods", "list", "size"}, "", runtime.AssumeColonVerbOpt(true)))
)
