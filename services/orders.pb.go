...
func (x *OrdersRequest) GetOrderMain() *OrderMain {
	if x != nil {
		return x.OrderMain
	}
	return nil
...
var file_orders_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0x43, 0x0a, 0x0d, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x73, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x32, 0x0a, 0x0a, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x5f, 0x6d,
	0x61, 0x69, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x73, 0x65, 0x72, 0x76,
	0x69, 0x63, 0x65, 0x73, 0x2e, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x4d, 0x61, 0x69, 0x6e, 0x52, 0x09,
	0x6f, 0x72, 0x64, 0x65, 0x72, 0x4d, 0x61, 0x69, 0x6e, 0x22, 0x42, 0x0a, 0x0e, 0x4f, 0x72, 0x64,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x32, 0x78, 0x0a,
	0x0d, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x73, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x67,
	...
	0x73, 0x2e, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	0x22, 0x25, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x1f, 0x22, 0x11, 0x2f, 0x76, 0x31, 0x2f, 0x6f, 0x72,
	0x64, 0x65, 0x72, 0x73, 0x2f, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x3a, 0x0a, 0x6f, 0x72, 0x64,
...
var file_orders_proto_goTypes = []interface{}{
	(*OrdersRequest)(nil),  // 0: services.OrdersRequest
	(*OrdersResponse)(nil), // 1: services.OrdersResponse
	(*OrderMain)(nil),      // 2: services.OrderMain
}
var file_orders_proto_depIdxs = []int32{
	2, // 0: services.OrdersRequest.order_main:type_name -> services.OrderMain
	0, // 1: services.OrdersService.CreateOrder:input_type -> services.OrdersRequest
	1, // 2: services.OrdersService.CreateOrder:output_type -> services.OrdersResponse
...
type OrdersServiceClient interface {
	CreateOrder(ctx context.Context, in *OrdersRequest, opts ...grpc.CallOption) (*OrdersResponse, error)
}
...
func (c *ordersServiceClient) CreateOrder(ctx context.Context, in *OrdersRequest, opts ...grpc.CallOption) (*OrdersResponse, error) {
...
type OrdersServiceServer interface {
	CreateOrder(context.Context, *OrdersRequest) (*OrdersResponse, error)
}
...
func (*UnimplementedOrdersServiceServer) CreateOrder(context.Context, *OrdersRequest) (*OrdersResponse, error) {
...
func _OrdersService_CreateOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrdersServiceServer).CreateOrder(ctx, req.(*OrdersRequest))
	}
